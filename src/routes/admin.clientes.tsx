      ...
      <div className="overflow-x-auto rounded-2xl bg-white shadow ring-1 ring-mocha/10">
        <table className="min-w-full text-sm">
          <thead className="bg-crema text-xs uppercase text-mocha">
            <tr><th className="p-3 text-left">Cliente</th><th className="p-3">WhatsApp</th><th className="p-3">Pedidos</th><th className="p-3">Gastado</th><th className="p-3">Último</th><th className="p-3">Promo</th></tr>
          </thead>
